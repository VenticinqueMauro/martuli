...
const NewspaperHeader: React.FC = () => {
  return (
    <header className="border-b-4 border-black pb-4 mb-8 text-center px-4">
      <div className="flex justify-between items-end text-xs md:text-sm font-bold border-b border-black mb-2 uppercase tracking-widest">
        <span>Precio: 20 Centavos</span>
        <span className="hidden md:block">San Miguel de Tucumán, Argentina</span>
        <span>Año I - N° 001</span>
      </div>
      
      <h1 className="newspaper-title text-5xl md:text-8xl my-4">El Heraldo Familiar</h1>
      
      <div className="border-y border-black py-1 mb-2 flex justify-center items-center gap-4">
        <div className="flex-1 h-px bg-black hidden md:block"></div>
